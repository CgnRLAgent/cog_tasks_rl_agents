...
save_train_res('./agents/cog_tasks_rl_agents/MonteCarlo/save/saccade/MC_7', res)
train_results_plots(dir='./agents/cog_tasks_rl_agents/MonteCarlo/save/saccade', figname='MC_7', names=['MC_7'], numbers=[res])
